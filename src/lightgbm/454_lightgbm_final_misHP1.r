...
PARAM$finalmodel$num_iterations <- 447
PARAM$finalmodel$learning_rate <- 0.0701942064914176
PARAM$finalmodel$feature_fraction <- 0.421214766649914
PARAM$finalmodel$min_data_in_leaf <- 80
PARAM$finalmodel$num_leaves <- 1290
PARAM$finalmodel$lambda_l1 = 4.0
PARAM$finalmodel$lambda_l2 = 64.0
