...
PARAM$finalmodel$num_iterations <- 129
PARAM$finalmodel$learning_rate <- 0.111922694077126
PARAM$finalmodel$feature_fraction <- 0.682829037294198
PARAM$finalmodel$min_data_in_leaf <- 252
PARAM$finalmodel$num_leaves <- 933
PARAM$finalmodel$lambda_l1 = 1
PARAM$finalmodel$lambda_l2 = 7


PARAM$finalmodel$max_bin <- 187
